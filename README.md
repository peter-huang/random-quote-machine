...
A React application that generates random quotes from a JSON file as part of the freecodecamp frontend development curriculum. I can use any mix of HTML, JavaScript, CSS, Bootstrap, SASS, React, Redux, and jQuery to complete this project.
